...
class _AuthClient implements AuthClient {
  ...
  Future<HttpResponse<RefreshTokenResponseDto>> postApiV1AuthSessionsRefresh({
    ...
    _data.addAll(
      body == null
          ? <String, dynamic>{}
          : await compute(serializeRefreshTokenDto, body),
    );
    final _options = _setStreamType<HttpResponse<RefreshTokenResponseDto>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    try {
      _value = await compute(deserializeRefreshTokenResponseDto, _result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  getApiV1AuthSessionsDevices() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ListDevicesResponseDto>>(
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late ListDevicesResponseDto _value;
    try {
      _value = await compute(deserializeListDevicesResponseDto, _result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
