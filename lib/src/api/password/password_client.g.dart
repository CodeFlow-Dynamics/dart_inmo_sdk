...
class _PasswordClient implements PasswordClient {
  _PasswordClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<TokenDto>> postApiV1PasswordForgotEmail({
    ...
    try {
      _value = await compute(deserializeTokenDto, _result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<String>> postApiV1PasswordReset({
    ...
    _data.addAll(
      body == null
          ? <String, dynamic>{}
          : await compute(serializeResetPasswordDto, body),
    );
  ...
  Future<HttpResponse<String>> postApiV1PasswordChange({
    ...
    _data.addAll(
      body == null
          ? <String, dynamic>{}
          : await compute(serializeChangePasswordDto, body),
    );
    final _options = _setStreamType<HttpResponse<String>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
