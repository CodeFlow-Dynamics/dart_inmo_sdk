...
import 'property/property_client.dart';
import 'property_category/property_category_client.dart';
import 'property_type/property_type_client.dart';
...
class InmoApi {
  ...
  PhoneClient? _phone;
  PropertyClient? _property;
  PropertyCategoryClient? _propertyCategory;
  PropertyTypeClient? _propertyType;
  ...
  PropertyClient get property => _property ??= PropertyClient(_dio, baseUrl: _baseUrl);

  PropertyCategoryClient get propertyCategory => _propertyCategory ??= PropertyCategoryClient(_dio, baseUrl: _baseUrl);

  PropertyTypeClient get propertyType => _propertyType ??= PropertyTypeClient(_dio, baseUrl: _baseUrl);
