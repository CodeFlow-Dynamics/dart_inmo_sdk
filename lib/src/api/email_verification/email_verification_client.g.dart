...
part of 'email_verification_client.dart';
...
class _EmailVerificationClient implements EmailVerificationClient {
  _EmailVerificationClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<void>> postApiV1AuthEmailVerificationsConfirm({
    ...
    _data.addAll(
      body == null
          ? <String, dynamic>{}
          : await compute(serializeAddVerifyTokenDto, body),
    );
