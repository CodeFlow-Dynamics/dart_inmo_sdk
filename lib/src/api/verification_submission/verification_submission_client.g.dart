...
part of 'verification_submission_client.dart';
...
class _VerificationSubmissionClient implements VerificationSubmissionClient {
  _VerificationSubmissionClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  getApiV1IdentityVerificationSubmissions({
    ...
    final _options =
        _setStreamType<HttpResponse<VerificationSubmissionDtoPaginatedResult>>(
    ...
    late VerificationSubmissionDtoPaginatedResult _value;
    try {
      _value = await compute(
        deserializeVerificationSubmissionDtoPaginatedResult,
        _result.data!,
      );
    } on Object catch (e, s) {
  ...
  postApiV1IdentityVerificationSubmissions({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late VerificationSubmissionDto _value;
    try {
      _value = await compute(
        deserializeVerificationSubmissionDto,
        _result.data!,
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  getApiV1IdentityVerificationSubmissionsIdHistory({required String id}) async {
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<List<VerificationSubmissionHistoryDto>>>(
          Options(method: 'GET', headers: _headers, extra: _extra)
              .compose(
                _dio.options,
    ...
    late List<VerificationSubmissionHistoryDto> _value;
    try {
      _value = await compute(
        deserializeVerificationSubmissionHistoryDtoList,
  ...
  putApiV1IdentityVerificationSubmissionsIdReview({
    ...
    _data.addAll(
      body == null
          ? <String, dynamic>{}
          : await compute(serializeReviewVerificationSubmissionDto, body),
    );
    final _options = _setStreamType<HttpResponse<VerificationSubmissionDto>>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
