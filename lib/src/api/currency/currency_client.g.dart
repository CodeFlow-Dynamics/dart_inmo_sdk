...
class _CurrencyClient implements CurrencyClient {
  ...
  @override
  Future<HttpResponse<List<CurrencyDto>>> getApiV1Currencies() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<CurrencyDto>>>(
  ...
  Future<HttpResponse<CurrencyDto>> getApiV1CurrenciesId({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<CurrencyDto>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    try {
      _value = await compute(deserializeCurrencyDto, _result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
