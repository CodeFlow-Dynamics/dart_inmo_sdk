...
class _CountryClient implements CountryClient {
  _CountryClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<ListCountriesResponseDto>> getApiV1Country() async {
    ...
    final _options = _setStreamType<HttpResponse<ListCountriesResponseDto>>(
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late ListCountriesResponseDto _value;
    try {
      _value = await compute(
        deserializeListCountriesResponseDto,
        _result.data!,
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
